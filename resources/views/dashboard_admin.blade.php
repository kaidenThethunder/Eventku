...
<body>
    <section class="d-flex items-center overflow-hidden" style="min-height: 100vh">
        <div class="d-flex flex-column align-items-center text-white" style="width: 20rem; background-color:#006B95;">
            ...
            <div class="link-nav d-flex flex-column align-items-center text-white w-100">
                <a class="text-white border-bottom w-100" href="javascript:void(0);" onclick="showContent('home','home1')">Dashboard</a>
                <a class="text-white border-bottom w-100" href="javascript:void(0);" onclick="showContent('tambah-event','tambah-event1')">Tambah Event</a>
                <a class="text-white border-bottom w-100" href="javascript:void(0);" onclick="showContent('lihat-event','lihat-event1')">Kelola Event</a>
                <a class="text-white border-bottom w-100" href="javascript:void(0);"onclick="showContent('lihat-partisipan','lihat-partisipan1')">Partisipan</a>
            </div>
        </div>
        ...
        <div class="w-100">
            <div class="d-flex justify-content-between align-items-center" style="height: 125px">
                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown">
                        <button class="btn btn-light dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false" style="font-size: 24px;">
                            Admin
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item" href="#" style="font-size: 20px;">Profile</a></li>
                            <li><a class="dropdown-item" href="/login" style="font-size: 20px;">Logout</a></li>
                        </ul>
                    </div>
                ...
                <div id="home" class="content active">
                    <div class="row mx-5">
                        <div class="col-12 col-md-6 col-lg-4 mt-5 rounded-5">
                            <div class="card rounded d-flex flex-column align-items-center gap-5 " style="padding:5rem ;">
    ...
    <!-- Form Tambah Event -->
                    <div class="container d-flex justify-content-center align-items-center">
                        <div class="card p-4 w-100" style="max-width: 600px; background-color: #fff; border-radius: 12px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="action-icons">
                                            <button class="btn-edit rounded-3" data-bs-toggle="modal" data-bs-target="#editEventModal"><img src="pencil.svg" alt="Edit" style="width: 20px; height: 20px;"></button>
                                            <button class="btn-hapus rounded-3"><img src="delete.svg" alt="hapus" style="width: 20px; height: 20px;"></button>
                                        </td>
                                    </tr>
                ...
                <!-- Modal -->
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="editEventForm">
                                        <div class="mb-3">
                                            <input type="text" class="form-control" id="editEventName" placeholder="Masukkan Nama Event" required>
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" class="form-control" id="editEventLocation" placeholder="Lokasi Event" required>
                                        </div>
                                        <div class="mb-3">
                                            <input type="date" class="form-control" id="editEventDate" placeholder="Tanggal" required>
                                        </div>
                                        <div class="mb-3">
                                            <input type="number" class="form-control" id="editEventPrice" placeholder="Harga Tiket" required>
                                        </div>
                                        <div class="mb-3">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Sudah Bayar</td>
                                            <td class="action-icons">
                                                <button class="btn-edit rounded-3" data-bs-toggle="modal" data-bs-target="#editPartisipanModal"><img src="pencil.svg" alt="Edit" style="width: 20px; height: 20px;"></button>
                                                <button class="btn-hapus rounded-3"><img src="delete.svg" alt="hapus" style="width: 20px; height: 20px;"></button>
                                            </td>
                                        </tr>
                                        <!-- Tambahkan data lainnya jika perlu -->
                    ...
                    <div class="modal fade" id="editPartisipanModal" tabindex="-1" aria-labelledby="editPartisipanModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <form id="editPartisipanForm">
                                        <div class="mb-3">
                                            <input type="text" class="form-control" id="editPartisipanName" placeholder="Masukkan Nama Partisipan" required>
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" class="form-control" id="editPartisipanAlamat" placeholder="Alamat Partisipan" required>
                                        </div>
                                        <div class="mb-3">
